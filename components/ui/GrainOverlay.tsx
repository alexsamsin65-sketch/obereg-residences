...
/**
 * GrainOverlay — тонкое киношное зерно поверх всего сайта (~3% opacity).
 * Рендерится через SVG noise-фильтр, статичный слой (не анимированный,
 * чтобы не нагружать GPU). Поверх всего, pointer-events: none.
 */
